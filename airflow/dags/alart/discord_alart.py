...
def task3(*args, **kwargs):
    ...
    try:
        volatility_image_path, content, fig = chart.comprehensive_market_assessment(
                                        volatility_ma_range=[5, 20]
                                        ,adls_slow=5
                                        ,adls_fast=1
                                        ,volume_std_window=200
                                        ,volume_mean_windown=3
                                        ,volume_k=2
                                        ,save_image=True)
...
task_4 = PythonOperator(task_id='adls', python_callable=task4, dag=dag)
